export const predefinedConnectivityModel = {
  ...
  'elements': [{
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 0, 'y': 340, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 450, 'y': 170, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 650, 'y': 180, 'width': 100, 'height': 100 },
    'marking': false,
  }],
  'relationships': [{
    ...
    'owner': null,
    'bounds': { 'x': 50, 'y': 100, 'width': 1, 'height': 240 },
    'path': [{ 'x': 0, 'y': 0 }, { 'x': 0, 'y': 240 }],
    'source': { 'direction': 'Down', 'element': 'c48ea3f2-a8f6-41f8-ade5-6a8170a2f98b' },
    'target': { 'direction': 'Up', 'element': '91c588a0-d53e-46ae-bfe5-2085d5bd47a6' },
  }, {
    'id': '5f156282-a2e8-4be2-a7b9-fddb5d24cbb5',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 100, 'y': 50, 'width': 350, 'height': 1 },
    'path': [{ 'x': 0, 'y': 0 }, { 'x': 350, 'y': 0 }],
    'source': { 'direction': 'Right', 'element': 'c48ea3f2-a8f6-41f8-ade5-6a8170a2f98b' },
    'target': { 'direction': 'Left', 'element': '49334502-d22f-4092-a579-c29936d24fd4' },
  }, {
    'id': 'df5f9e9c-35f2-4bb9-a94e-6aedc8b8ce56',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 500, 'y': 100, 'width': 1, 'height': 70 },
    'path': [{ 'x': 0, 'y': 0 }, { 'x': 0, 'y': 70 }],
    'source': { 'direction': 'Down', 'element': '49334502-d22f-4092-a579-c29936d24fd4' },
    'target': { 'direction': 'Up', 'element': '61adcc2b-96d5-40d2-a602-c44e5c831517' },
  }, {
    'id': '0f432c74-5051-4e0c-8814-e412480053b6',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 550, 'y': 50, 'width': 100, 'height': 1 },
    'path': [{ 'x': 0, 'y': 0 }, { 'x': 100, 'y': 0 }],
    'source': { 'direction': 'Right', 'element': '49334502-d22f-4092-a579-c29936d24fd4' },
    'target': { 'direction': 'Left', 'element': '7e1a0d85-d192-4780-9161-9921887bf673' },
  }, {
    'id': '8f2ddb91-7582-423e-a0e8-9c1bd5b657b6',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 500, 'y': 0, 'width': 200, 'height': 1 },
    'path': [{ 'x': 200, 'y': 0 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Up', 'element': '7e1a0d85-d192-4780-9161-9921887bf673' },
    'target': { 'direction': 'Up', 'element': '49334502-d22f-4092-a579-c29936d24fd4' },
  }, {
    'id': '3d82e5f0-c226-4490-811c-8a5a74e77b25',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 100, 'y': 390, 'width': 350, 'height': 1 },
    'path': [{ 'x': 350, 'y': 0 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Left', 'element': 'd66a6fa8-60cc-43d4-bf7c-5edd014df0e2' },
    'target': { 'direction': 'Right', 'element': '91c588a0-d53e-46ae-bfe5-2085d5bd47a6' },
  }, {
    'id': '0b786ec8-2218-43da-bace-837d71920f21',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 500, 'y': 270, 'width': 1, 'height': 70 },
    'path': [{ 'x': 0, 'y': 70 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Up', 'element': 'd66a6fa8-60cc-43d4-bf7c-5edd014df0e2' },
    'target': { 'direction': 'Down', 'element': '61adcc2b-96d5-40d2-a602-c44e5c831517' },
  }, {
    'id': '5b73d58f-3df6-44ce-815b-012499170d02',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 700, 'y': 100, 'width': 1, 'height': 80 },
    'path': [{ 'x': 0, 'y': 80 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Up', 'element': '0ccbd205-e01e-4fbc-ab9a-c3381446b830' },
    'target': { 'direction': 'Down', 'element': '7e1a0d85-d192-4780-9161-9921887bf673' },
  }],
  'assessments': [],
};
...
export const predefinedCutVertexModel = {
  ...
  'elements': [{
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 0, 'y': 120, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 240, 'y': 260, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 240, 'y': 120, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 490, 'y': 0, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 490, 'y': 270, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 780, 'y': 0, 'width': 100, 'height': 100 },
    'marking': false,
  }, {
    ...
    'type': 'MarkedGraphNode',
    'owner': null,
    'bounds': { 'x': 780, 'y': 270, 'width': 100, 'height': 100 },
    'marking': false,
  }],
  'relationships': [{
    ...
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 830, 'y': 100, 'width': 1, 'height': 170 },
    'path': [{ 'x': 0, 'y': 170 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Up', 'element': '7e4f70ff-a374-4d0d-959e-5bbaa29e482c' },
    'target': { 'direction': 'Down', 'element': '3becfbf8-0cda-44d0-9795-5e734dec7ae9' },
  }, {
    'id': '0a919d42-5bfa-4810-83e0-e81a0574968b',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 590, 'y': 50, 'width': 190, 'height': 1 },
    'path': [{ 'x': 0, 'y': 0 }, { 'x': 190, 'y': 0 }],
    'source': { 'direction': 'Right', 'element': 'e2e32bb1-857d-45c3-81aa-7f68bb961557' },
    'target': { 'direction': 'Left', 'element': '3becfbf8-0cda-44d0-9795-5e734dec7ae9' },
  }, {
    'id': '092e8f40-6517-429a-8702-977a7ea30573',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 590, 'y': 320, 'width': 190, 'height': 1 },
    'path': [{ 'x': 0, 'y': 0 }, { 'x': 190, 'y': 0 }],
    'source': { 'direction': 'Right', 'element': '7c9c54b3-a5d8-4731-9f39-bc8f66abaedd' },
    'target': { 'direction': 'Left', 'element': '7e4f70ff-a374-4d0d-959e-5bbaa29e482c' },
  }, {
    'id': '01fc3bc5-a7ec-4544-a041-d67d36c01604',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 540, 'y': 100, 'width': 1, 'height': 170 },
    'path': [{ 'x': 0, 'y': 170 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Up', 'element': '7c9c54b3-a5d8-4731-9f39-bc8f66abaedd' },
    'target': { 'direction': 'Down', 'element': 'e2e32bb1-857d-45c3-81aa-7f68bb961557' },
  }, {
    'id': 'f5888a16-c3b5-486a-8124-d69dc04563ec',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 290, 'y': 50, 'width': 200, 'height': 70 },
    'path': [{ 'x': 200, 'y': 0 }, { 'x': 0, 'y': 70 }],
    'source': { 'direction': 'Left', 'element': 'e2e32bb1-857d-45c3-81aa-7f68bb961557' },
    'target': { 'direction': 'Up', 'element': 'ebc633af-df92-4c24-b238-12c74465055b' },
  }, {
    'id': '343984b2-98ae-4330-b8dc-50ae52a61631',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 340, 'y': 170, 'width': 150, 'height': 150 },
    'path': [{ 'x': 150, 'y': 150 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Left', 'element': '7c9c54b3-a5d8-4731-9f39-bc8f66abaedd' },
    'target': { 'direction': 'Right', 'element': 'ebc633af-df92-4c24-b238-12c74465055b' },
  }, {
    'id': 'b2abfcc3-b146-4656-82a0-2897a08ff9f4',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 100, 'y': 170, 'width': 140, 'height': 1 },
    'path': [{ 'x': 140, 'y': 0 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Left', 'element': 'ebc633af-df92-4c24-b238-12c74465055b' },
    'target': { 'direction': 'Right', 'element': '72bc0627-a91e-436c-9e7b-2d89a5406c32' },
  }, {
    'id': '922e6d7e-2555-4269-9e2c-68fc4b42fa88',
    'name': '',
    'type': 'MarkedGraphEdge',
    'owner': null,
    'bounds': { 'x': 290, 'y': 220, 'width': 1, 'height': 40 },
    'path': [{ 'x': 0, 'y': 40 }, { 'x': 0, 'y': 0 }],
    'source': { 'direction': 'Up', 'element': 'eecef3a6-f503-40a0-9a96-203c2f64c174' },
    'target': { 'direction': 'Down', 'element': 'ebc633af-df92-4c24-b238-12c74465055b' },
  }],
  'assessments': [],
};
