...
import { MarkedGraphRelationshipType } from './marked-graph';
...
export type UMLRelationshipType =
  ...
  | keyof typeof MarkedGraphRelationshipType;
...
export const DefaultUMLRelationshipType: { [key in UMLDiagramType]: UMLRelationshipType } = {
  ...
  [UMLDiagramType.MarkedGraph]: MarkedGraphRelationshipType.MarkedGraphEdge,
};
